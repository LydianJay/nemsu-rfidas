                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                <div class="card-header">
                                    <h5 class="card-title text-center px-1 fs-4 text-danger">In Development</h5>
                                </div>
                                <div class="card-body">

                                    <div class="pt-4 pb-2">
                                        <p class="fs-5 text-danger text-center fw-bold">This feature or page is currently in development</p>
                                    </div>
